...
%                                                  %
%4. Use the filematALL (line 26) to set the pattern%
%   you want to use to look for files and          %
%   pathToFiles (line 28) to specify the  directory%
%                                                  %
%5. Run PART 1 (Run Section)                       %
%--------------------------------------------------%
...
%%
%--------------------------------------------------%
%6. Use the filematALL (line 51) to set the pattern%
%   you want to use to look for files and          %
%   pathToFilesSplit (line 53) to specify the      %
%   directory. (these files should be in the       %
%   Split_Condition folder from above)             %
%                                                  %
%7. Run PART 2 (Run Section)                       %
%--------------------------------------------------%
...
BEES_clean_data_batch(filemat, pathToFilesSplit);
